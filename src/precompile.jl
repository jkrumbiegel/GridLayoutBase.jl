...
function _precompile_()
    ...
    @warnpcfail precompile(add_to_gridlayout!, (GridLayout, GridContent{GridLayout}))
    @warnpcfail precompile(connect_layoutobservables!, (GridContent{GridLayout},))
    ...
    for S in (Left, Right, Top, Bottom)
        @warnpcfail precompile(protrusion, (GridContent{GridLayout}, S))
    end
